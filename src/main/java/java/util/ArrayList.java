        ...
        implements List<E>, RandomAccess, Cloneable, java.io.Serializable
{
     ...
     * 数组的长度
     * 如果是在方法里声明一个　int size，然后输出size编译是不会通过的。也就是在方法里声明没有默认值。在类里声明，初始化对象时，会给成员变量赋值默认值，如int默认值是0
     *
     * @serial
     */
    private int size;
    ...
    //大于MAX_ARRAY_SIZE 则 赋值 大于MAX_ARRAY_SIZE + 8 =  Integer.MAX_VALUE
